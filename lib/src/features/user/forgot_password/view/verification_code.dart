...
class VerificationPage extends StatefulWidget {
  ...
  const VerificationPage({super.key, this.userEmail});
                ...
                children: [
                  ...
                  Text.rich(
                    TextSpan(
                      children: [
                        TextSpan(
                            text: "We’ve sent you the verification code on ",
                            style: textTheme(context).bodySmall?.copyWith(
                                  color: colorScheme(context).onSurface,
                                )),
                        TextSpan(
                            text: widget.userEmail ?? "+447700900077",
                            style: textTheme(context).bodySmall?.copyWith(
                                  color: colorScheme(context).onSurface,
                                )),
                      ],
                    ...
                    child: Obx(() {
                      return Row(
                        ...
                        children: [
                          ...
                          Text(
                            "0:${timerController.start.value.toString().padLeft(2, '0')}",
                            style: textTheme(context).bodySmall?.copyWith(
                                  fontSize: 13,
                                  color: colorScheme(context).onSurface,
                                ),
